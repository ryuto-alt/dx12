...
constexpr const char* kEngineVersion = "1.4.2";
...
constexpr const char* kWhatsNewTitle = "DX12 Engine v1.4.2 の更新内容";
constexpr const char* kWhatsNewBody =
    "v1.4.2: 起動時に前回プロジェクトを自動で開く挙動を廃止\n"
    "\n"
    "・起動すると必ずプロジェクトランチャー(テンプレート選択画面)を表示\n"
    "  するように変更。前回のプロジェクト/シーンの自動復元は行わない\n";
} // namespace dx12e
